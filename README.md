...
| [PM Club at UCSC site](https://github.com/riptide-06/pmclub-site) | Recruitment site for UC Santa Cruz's first product management club, with a full application flow: resume upload to Vercel Blob and an Airtable row per applicant. | HTML, CSS, JavaScript, Vercel serverless function | Racing; live at [productatucsc.org](https://productslugs.vercel.app) |
